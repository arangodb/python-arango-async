...
class Cursor:
    ...
    async def fetch(self, batch_id: Optional[str] = None) -> List[Any]:
        ...
        References:
            - `read-the-next-batch-from-a-cursor <https://docs.arango.ai/arangodb/stable/develop/http-api/queries/aql-queries/#read-the-next-batch-from-a-cursor>`__
            - `read-a-batch-from-the-cursor-again <https://docs.arango.ai/arangodb/stable/develop/http-api/queries/aql-queries/#read-a-batch-from-the-cursor-again>`__
        """  # noqa: E501
        if self._id is None:
    ...
    async def close(self, ignore_missing: bool = False) -> bool:
        ...
        References:
            - `delete-a-cursor <https://docs.arango.ai/arangodb/stable/develop/http-api/queries/aql-queries/#delete-a-cursor>`__
        """  # noqa: E501
        if self._id is None:
            return False
