...
class Foxx:
    ...
    async def services(self, exclude_system: Optional[bool] = False) -> Result[Jsons]:
        ...
        References:
            - `list-the-installed-services <https://docs.arango.ai/arangodb/stable/develop/http-api/foxx/#list-the-installed-services>`__
        """  # noqa: E501
        params: Params = {}
    ...
    async def service(self, mount: str) -> Result[Json]:
        ...
        References:
            - `get-the-service-description <https://docs.arango.ai/arangodb/stable/develop/http-api/foxx/#get-the-service-description>`__
        """  # noqa: E501
    ...
    async def create_service(
        ...
        References:
           - `install-a-new-service-mode <https://docs.arango.ai/arangodb/stable/develop/http-api/foxx/#install-a-new-service>`__
        """  # noqa: E501
        params: Params = dict()
        params["mount"] = mount
    ...
    async def delete_service(
        ...
        References:
            - `uninstall-a-service <https://docs.arango.ai/arangodb/stable/develop/http-api/foxx/#uninstall-a-service>`__
        """  # noqa: E501
        params: Params = dict()
        params["mount"] = mount
    ...
    async def replace_service(
        ...
        References:
            - `replace-a-service <https://docs.arango.ai/arangodb/stable/develop/http-api/foxx/#replace-a-service>`__
        """  # noqa: E501
        params: Params = dict()
        params["mount"] = mount
        if teardown is not None:
    ...
    async def update_service(
        ...
        References:
            - `upgrade-a-service <https://docs.arango.ai/arangodb/stable/develop/http-api/foxx/#upgrade-a-service>`__
        """  # noqa: E501
        params: Params = dict()
        params["mount"] = mount
        if teardown is not None:
    ...
    async def config(self, mount: str) -> Result[Json]:
        ...
        References:
            - `get-the-configuration-options <https://docs.arango.ai/arangodb/stable/develop/http-api/foxx/#get-the-configuration-options>`__
        """  # noqa: E501
        request = Request(
            method=Method.GET,
    ...
    async def update_config(self, mount: str, options: Json) -> Result[Json]:
        ...
        References:
            - `update-the-configuration-options <https://docs.arango.ai/arangodb/stable/develop/http-api/foxx/#update-the-configuration-options>`__
        """  # noqa: E501
        request = Request(
            method=Method.PATCH,
            endpoint="/_api/foxx/configuration",
    ...
    async def replace_config(self, mount: str, options: Json) -> Result[Json]:
        ...
        References:
            - `replace-the-configuration-options <https://docs.arango.ai/arangodb/stable/develop/http-api/foxx/#replace-the-configuration-options>`__
        """  # noqa: E501
        request = Request(
            method=Method.PUT,
            endpoint="/_api/foxx/configuration",
    ...
    async def dependencies(self, mount: str) -> Result[Json]:
        ...
        References:
           - `get-the-dependency-options <https://docs.arango.ai/arangodb/stable/develop/http-api/foxx/#get-the-dependency-options>`__
        """  # noqa: E501
        request = Request(
            method=Method.GET,
    ...
    async def update_dependencies(self, mount: str, options: Json) -> Result[Json]:
        ...
        References:
            - `update-the-dependency-options <https://docs.arango.ai/arangodb/stable/develop/http-api/foxx/#update-the-dependency-options>`__
        """  # noqa: E501
        request = Request(
            method=Method.PATCH,
            endpoint="/_api/foxx/dependencies",
    ...
    async def replace_dependencies(self, mount: str, options: Json) -> Result[Json]:
        ...
        References:
            - `replace-the-dependency-options <https://docs.arango.ai/arangodb/stable/develop/http-api/foxx/#replace-the-dependency-options>`__
        """  # noqa: E501
        request = Request(
            method=Method.PUT,
            endpoint="/_api/foxx/dependencies",
    ...
    async def scripts(self, mount: str) -> Result[Json]:
        ...
        References:
            - `list-the-service-scripts <https://docs.arango.ai/arangodb/stable/develop/http-api/foxx/#list-the-service-scripts>`__
        """  # noqa: E501
        request = Request(
            method=Method.GET,
    ...
    async def run_script(
        ...
        References:
           - `run-a-service-script <https://docs.arango.ai/arangodb/stable/develop/http-api/foxx/#run-a-service-script>`__
        """  # noqa: E501
        request = Request(
            method=Method.POST,
    ...
    async def run_tests(
        ...
        References:
           - `run-the-service-tests <https://docs.arango.ai/arangodb/stable/develop/http-api/foxx/#run-the-service-tests>`__
        """  # noqa: E501
        params: Params = dict()
        params["mount"] = mount
    ...
    async def enable_development(self, mount: str) -> Result[Json]:
        ...
        References:
           - `enable-the-development-mode <https://docs.arango.ai/arangodb/stable/develop/http-api/foxx/#enable-the-development-mode>`__
        """  # noqa: E501
        request = Request(
            method=Method.POST,
    ...
    async def disable_development(self, mount: str) -> Result[Json]:
        ...
        References:
            - `disable-the-development-mode <https://docs.arango.ai/arangodb/stable/develop/http-api/foxx/#disable-the-development-mode>`__
        """  # noqa: E501
        request = Request(
            method=Method.DELETE,
            endpoint="/_api/foxx/development",
    ...
    async def readme(self, mount: str) -> Result[str]:
        ...
        References:
            - `get-the-service-readme <https://docs.arango.ai/arangodb/stable/develop/http-api/foxx/#get-the-service-readme>`__
        """  # noqa: E501
        request = Request(
            method=Method.GET,
    ...
    async def swagger(self, mount: str) -> Result[Json]:
        ...
        References:
           - `get-the-swagger-description <https://docs.arango.ai/arangodb/stable/develop/http-api/foxx/#get-the-swagger-description>`__
        """  # noqa: E501
        request = Request(
    ...
    async def download(self, mount: str) -> Result[bytes]:
        ...
        References:
           - `download-a-service-bundle <https://docs.arango.ai/arangodb/stable/develop/http-api/foxx/#download-a-service-bundle>`__
        """  # noqa: E501
        request = Request(
    ...
    async def commit(self, replace: Optional[bool] = None) -> None:
        ...
        References:
            - `commit-the-local-service-state <https://docs.arango.ai/arangodb/stable/develop/http-api/foxx/#commit-the-local-service-state>`__
        """  # noqa: E501
        params: Params = {}
