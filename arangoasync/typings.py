...
class KeyOptions(JsonWrapper):
    ...
    References:
        - `create-a-collection <https://docs.arango.ai/arangodb/stable/develop/http-api/collections/#create-a-collection_body_keyOptions>`__
    """  # noqa: E501
...
class CollectionInfo(JsonWrapper):
    ...
    References:
        - `get-the-collection-information <https://docs.arango.ai/arangodb/stable/develop/http-api/collections/#get-the-collection-information>`__
    """  # noqa: E501
...
class QueryProperties(JsonWrapper):
    ...
    References:
        - `create-a-cursor <https://docs.arango.ai/arangodb/stable/develop/http-api/queries/aql-queries/#create-a-cursor_body_options>`__
    """  # noqa: E501
...
class QueryExecutionPlan(JsonWrapper):
    ...
    References:
        - `plan <https://docs.arango.ai/arangodb/stable/develop/http-api/queries/aql-queries/#create-a-cursor_res_201_extra_plan>`__
    """  # noqa: E501
...
class QueryExecutionProfile(JsonWrapper):
    ...
    References:
        - `profile <https://docs.arango.ai/arangodb/stable/develop/http-api/queries/aql-queries/#create-a-cursor_res_201_extra_profile>`__
    """  # noqa: E501
...
class QueryExecutionStats(JsonWrapper):
    ...
    References:
        - `stats <https://docs.arango.ai/arangodb/stable/develop/http-api/queries/aql-queries/#create-a-cursor_res_201_extra_stats>`__
    """  # noqa: E501
...
class QueryExecutionExtra(JsonWrapper):
    ...
    References:
        - `extra <https://docs.arango.ai/arangodb/stable/develop/http-api/queries/aql-queries/#create-a-cursor_res_201_extra>`__
    """  # noqa: E501
